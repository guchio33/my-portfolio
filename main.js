...
serchbutton.onclick = function () {
  ...
  if (text == "趣味は何ですか？") {
    ...
    quizImage.src = "images/karei.jpeg";
  } else if (text == "こんにちは") {
